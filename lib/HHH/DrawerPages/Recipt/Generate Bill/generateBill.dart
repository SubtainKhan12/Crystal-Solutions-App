...
class BillGenerationUi extends StatefulWidget {
  GetActiveCustomersModel getActiveCustomersList;
   BillGenerationUi({super.key,required this.getActiveCustomersList});

  @override
  State<BillGenerationUi> createState() => _BillGenerationUiState();
}

class _BillGenerationUiState extends State<BillGenerationUi> {
  ...
  Future post_newBill()async{
    var response = await http.post(Uri.parse(newBill),body: {
