...
class GetActiveDesignationModel {
  GetActiveDesignationModel({
      String? tdsgid, 
      String? tdsgdsc, 
      String? tdsgsts,}){
    _tdsgid = tdsgid;
  ...
  GetActiveDesignationModel.fromJson(dynamic json) {
    _tdsgid = json['tdsgid'];
  ...
  String? _tdsgdsc;
  String? _tdsgsts;
GetActiveDesignationModel copyWith({  String? tdsgid,
  String? tdsgdsc,
  String? tdsgsts,
}) => GetActiveDesignationModel(  tdsgid: tdsgid ?? _tdsgid,
