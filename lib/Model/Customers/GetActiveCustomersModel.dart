...
class GetActiveCustomersModel {
  ...
  GetActiveCustomersModel.fromJson(dynamic json) {
    _tcstid = json['tcstid'];
  ...
  String? _tSrvIp;
  dynamic _tCstPic;
GetActiveCustomersModel copyWith({  String? tcstid,
  String? tCstDsc,
  String? tCstSts,
  String? tCntPer,
  String? tMobNUm,
  ...
  String? tSrvIp,
  dynamic tCstPic,
}) => GetActiveCustomersModel(  tcstid: tcstid ?? _tcstid,
  ...
  String? get tarrchg => _tarrchg;
  String? get tsrvchg => _tsrvchg;
  String? get tmthChg => _tmthChg;
  String? get tsmschg => _tsmschg;
  String? get tadvchg => _tadvchg;
  String? get tposchg => _tposchg;
  String? get tothchg => _tothchg;
